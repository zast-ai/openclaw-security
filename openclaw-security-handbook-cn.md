...
这三者叠加，使得一次成功的攻击可以造成极大破坏。Acronis 威胁研究团队将其称为"新型特权身份"。截至 2026 年 3月，已有 **140,000+ 台公开暴露的 OpenClaw 实例**被扫描发现，Pillar Security 记录了针对这些实例的大规模自动化攻击——包括凭证窃取、命令执行、会话劫持。
